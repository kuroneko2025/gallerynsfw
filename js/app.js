const KuronekoApp = (function() {
    ...
    function setupLanguageSelector() {
        ...
        if (DOM.languageSelector) {
            ...
            DOM.languageSelector.addEventListener('change', function(e) {
                ...
                // Notificar a Messages sobre cambio de idioma
    ...
    function handleUserLogout() {
        ...
        // Detener cualquier actualización automática en Messages
    ...
    function handleUserLogin(user) {
        ...
        if (currentSection === 'messages') {
            ...
            // Messages manejará internamente la carga inicial
        ...
        document.addEventListener('sectionChanged', function(e) {
            if (e.detail.section === 'messages') {
                ...
                if (savedUser) {
                    ...
                    // Notificar a Messages que la sección está activa
                    ...
                    // Notificar a Messages que la sección está inactiva
                    if (typeof Messages !== 'undefined' && Messages.onSectionDeactivated) {
                        Messages.onSectionDeactivated();
                    }
                }
            } else {
                // Cuando se cambia a otra sección, notificar a Messages
                if (typeof Messages !== 'undefined' && Messages.onSectionDeactivated) {
                    Messages.onSectionDeactivated();
                }
            }
    ...
    async function init() {
        ...
        try {
            console.log('Iniciando aplicación くろねこ...');
    ...
    // Retornar el objeto público de KuronekoApp
    return {
        init: init,
        ...
        setLanguage: function(lang) {
            if (typeof Utils !== 'undefined' && Utils.translations && Utils.translations[lang]) {
                ...
                // Notificar cambio de idioma a Messages
        ...
        getStats: function() {
            const stats = {
                ageVerified: typeof AgeVerification !== 'undefined' && AgeVerification.isVerified ? AgeVerification.isVerified() : false,
            ...
            if (typeof Messages !== 'undefined') {
                ...
                stats.isVendedor = user ? user.isVendedor : false;
...
// Event listeners fuera de la IIFE
...
document.addEventListener('visibilitychange', function() {
    if (document.hidden) {
        ...
        // Notificar a Messages que la página está oculta
        ...
        if (KuronekoApp.isInitialized && KuronekoApp.isInitialized()) {
            ...
            // Notificar a Messages que la página es visible
