const Utils = {
    translations: {
        es: {
            ...
            'product-negotiable': 'Precio negociable',
            ...
            'sort-price-low': 'Precio: menor a mayor',
            'sort-price-high': 'Precio: mayor a menor',
        ...
        en: {
            ...
            'product-sold': 'Sold',
            'product-negotiable': 'Price negotiable',
        ...
        ja: {
            ...
            'product-sold': '売り切れ',
            'product-negotiable': '価格交渉可能',

            'filter-all': 'すべて',
            'filter-available': '在庫あり',
            'filter-sold': '売り切れ',
            'sort-newest': '新しい順',
            'sort-oldest': '古い順',
            'sort-price-low': '価格: 安い順',
            'sort-price-high': '価格: 高い順',
    ...
    handleSmoothScrolling: function () {
        document.querySelectorAll('a[href^="#"]').forEach(anchor => {
            anchor.addEventListener('click', function (e) {
                ...
                // Si es solo "#", no hacer nada (evita el error)
            });
        });
    },
    ...
    // Función para debounce (mejorar performance)
    ...
    // Función para throttle (mejorar performance)
