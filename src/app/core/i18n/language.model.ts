...
export interface TranslationMap {
  ...
  linktree: {
    ...
    paypalSupportTitle: string;
    paypalSuggestedLabel: string;
    paypalCustomLabel: string;
    paypalCustomPlaceholder: string;
    paypalCustomAction: string;
    paypalCustomError: string;
    xLabel: string;
    xSmall: string;
    systemButton: string;
    systemSmall: string;
  ...
  admin: {
    ...
    linktree: {
      ...
      paypalAllowCustomAmount: string;
      ...
      itemDisableSuccess: string;
      itemEnableSuccess: string;
