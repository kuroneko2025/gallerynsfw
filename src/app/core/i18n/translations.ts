...
export const TRANSLATIONS: Record<LanguageCode, TranslationMap> = {
  ja: {
    ...
    linktree: {
      ...
      introLine3: '限定ギャラリーのアクセス情報は、準備が整い次第お知らせします。',
      paymentNoticeTitle: 'お支払い方法について',
      paymentNoticeMessage: '現在、お支払い方法は追って通知があるまでご利用いただけません。',
      paymentSectionTitle: 'サポートとウォレット',
      paypalSupportTitle: 'PayPalでサポート',
      paypalSuggestedLabel: 'おすすめ金額を選ぶか、自由な金額を入力してください。',
      paypalCustomLabel: '自由入力の金額',
      paypalCustomPlaceholder: '例: 12.50',
      paypalCustomAction: 'PayPalを開く',
      paypalCustomError: '1から10000までの有効な金額を入力してください。',
      xLabel: 'X',
      xSmall: '最新情報',
    ...
    admin: {
      ...
      keyStatus: {
        all: 'すべて',
        expiringSoon: '期限間近',
        summaryTitle: 'アクセスキーの状態',
        daysRemaining: '期限まであと {days} 日です。',
        expiresToday: '本日で期限が切れます。',
        expiredDaysAgo: '{days} 日前に期限切れです。',
        disabledHelp: 'このアクセスキーは管理者により無効化されています。',
        noExpiration: '終了日を確認できません。'
      },
      requestFilters: {
        all: 'すべて',
        pending: '確認待ち',
      ...
      linktree: {
        kicker: 'Linktree',
        title: 'Linktree管理',
        subtitle: '公開リンク、支援リンク、ウォレット、PayPal表示を管理します。',
        settingsTitle: '公開設定',
        settingsDescription: '支払い状態、PayPal情報、期限間近の基準日数を編集します。',
        paymentStatus: '支払い状態',
        paymentEnabled: '有効',
        paymentDisabled: '一時停止',
        noticeTitle: '支払い停止タイトル',
        noticeMessage: '支払い停止メッセージ',
        paypalEnabled: 'PayPal表示',
        paypalUrl: 'PayPal公開URL',
        paypalCurrency: '通貨',
        paypalSuggestedAmounts: 'おすすめ金額',
        paypalAllowCustomAmount: '自由入力の金額を許可',
        expiringSoonDays: '期限間近の日数',
        saveSettings: '設定を保存',
        addItem: 'リンクを追加',
        editItem: 'リンクを編集',
        cancelEdit: '編集をキャンセル',
        ...
        custom: 'カスタム',
        saveItem: 'リンクを保存',
        inputError: '入力内容、URL、JSONを確認してください。',
        loadError: 'Linktree設定を読み込めませんでした。',
        saveSuccess: 'Linktree設定を保存しました。',
        itemSaveSuccess: 'Linktreeリンクを保存しました。',
        itemDisableSuccess: 'リンクを無効化しました。',
        itemEnableSuccess: 'リンクを有効化しました。',
        itemDeleteSuccess: 'リンクを削除しました。',
        filterAll: 'すべて',
        filtersLabel: 'Linktreeフィルター',
        search: '検索',
        searchPlaceholder: 'ID、提供元、URL、ラベルで検索',
        results: '件',
        empty: 'Linktreeリンクは登録されていません。',
        loading: 'Linktree設定を読み込んでいます...',
        enable: '有効化',
        disable: '無効化',
        delete: '削除',
        edit: '編集',
        amountHelp: 'おすすめ金額はカンマ区切りで入力します。PayPalの秘密情報は保存しないでください。'
      }
    },
    footer: {
  ...
  es: {
    ...
    linktree: {
      ...
      introLine3: 'El acceso a la galería exclusiva se comunicará cuando vuelva a estar disponible.',
      paymentNoticeTitle: 'Medios de pago pausados',
      paymentNoticeMessage: 'Actualmente los medios de pago no estarán disponibles hasta nuevo aviso.',
      paymentSectionTitle: 'Soporte y billeteras',
      paypalSupportTitle: 'Apoyo por PayPal',
      paypalSuggestedLabel: 'Selecciona un monto sugerido o ingresa un aporte personalizado.',
      paypalCustomLabel: 'Monto personalizado',
      paypalCustomPlaceholder: 'Ej. 12.50',
      paypalCustomAction: 'Abrir PayPal',
      paypalCustomError: 'Ingresa un monto válido entre 1 y 10000.',
      xLabel: 'X',
      xSmall: 'Novedades',
    ...
    admin: {
      ...
      keyStatus: {
        ...
        summaryTitle: 'Estado de claves de acceso',
        daysRemaining: 'Faltan {days} días para el vencimiento.',
        expiresToday: 'Vence hoy.',
        expiredDaysAgo: 'Venció hace {days} días.',
        disabledHelp: 'Esta clave fue deshabilitada por administración.',
        noExpiration: 'No se pudo leer la fecha de vencimiento.'
      },
      requestFilters: {
        all: 'Todo',
        pending: 'Pendiente',
      ...
      linktree: {
        kicker: 'Linktree',
        title: 'Administración de Linktree',
        subtitle: 'Gestiona enlaces públicos, soporte, billeteras y visibilidad de PayPal.',
        settingsTitle: 'Configuración pública',
        settingsDescription: 'Edita el estado de pagos, datos públicos de PayPal y aviso de vencimiento de claves.',
        paymentStatus: 'Estado de pagos',
        paymentEnabled: 'Disponible',
        paymentDisabled: 'Pausado',
        noticeTitle: 'Título del aviso de pagos',
        noticeMessage: 'Mensaje del aviso de pagos',
        paypalEnabled: 'Mostrar PayPal',
        paypalUrl: 'URL pública de PayPal',
        paypalCurrency: 'Moneda',
        paypalSuggestedAmounts: 'Montos sugeridos',
        paypalAllowCustomAmount: 'Permitir monto personalizado',
        expiringSoonDays: 'Días para marcar por vencer',
        saveSettings: 'Guardar configuración',
        addItem: 'Agregar enlace',
        editItem: 'Editar enlace',
        ...
        sortOrder: 'Orden',
        url: 'URL',
        requiresAdultWarning: 'Requiere aviso +18',
        metadata: 'Metadata JSON',
        label: 'Etiqueta',
        subtitleField: 'Descripción corta',
        active: 'Activo',
        disabled: 'Deshabilitado',
        ...
        general: 'General',
        adult: '+18',
        paymentSection: 'Soporte',
        custom: 'Personalizado',
        saveItem: 'Guardar enlace',
        inputError: 'Revisa los campos, la URL y el JSON.',
        loadError: 'No se pudo cargar la configuración de Linktree.',
        saveSuccess: 'Configuración de Linktree guardada.',
        itemSaveSuccess: 'Enlace de Linktree guardado.',
        itemDisableSuccess: 'Enlace deshabilitado.',
        itemEnableSuccess: 'Enlace habilitado.',
        itemDeleteSuccess: 'Enlace eliminado.',
        filterAll: 'Todo',
        filtersLabel: 'Filtros de Linktree',
        search: 'Buscar',
        searchPlaceholder: 'Buscar por ID, proveedor, URL o etiqueta',
        results: 'resultados',
        empty: 'No hay enlaces de Linktree registrados.',
        loading: 'Cargando configuración de Linktree...',
        enable: 'Habilitar',
        disable: 'Deshabilitar',
        delete: 'Eliminar',
        edit: 'Editar',
        amountHelp: 'Los montos sugeridos se escriben separados por coma. No guardes secretos ni credenciales de PayPal.'
      }
    },
    footer: {
      copyright: '© 2026 クロネコシステム',
  ...
  en: {
    ...
    linktree: {
      ...
      introLine3: 'Access to the exclusive gallery will be announced when it becomes available again.',
      paymentNoticeTitle: 'Payment methods paused',
      paymentNoticeMessage: 'Payment methods are currently unavailable until further notice.',
      paymentSectionTitle: 'Support and wallets',
      paypalSupportTitle: 'Support via PayPal',
      paypalSuggestedLabel: 'Choose a suggested amount or enter a custom contribution.',
      paypalCustomLabel: 'Custom amount',
      paypalCustomPlaceholder: 'E.g. 12.50',
      paypalCustomAction: 'Open PayPal',
      paypalCustomError: 'Enter a valid amount between 1 and 10000.',
      xLabel: 'X',
      xSmall: 'Updates',
    ...
    admin: {
      ...
      keyStatus: {
        ...
        summaryTitle: 'Access key status',
        daysRemaining: '{days} days remaining.',
        expiresToday: 'Expires today.',
        expiredDaysAgo: 'Expired {days} days ago.',
        disabledHelp: 'This access key was disabled by an administrator.',
        noExpiration: 'The expiration date could not be read.'
      },
      requestFilters: {
        all: 'All',
        pending: 'Pending',
      ...
      linktree: {
        ...
        subtitle: 'Manage public links, support links, wallets, and PayPal visibility.',
        settingsTitle: 'Public settings',
        settingsDescription: 'Edit payment availability, public PayPal information, and key expiration warning days.',
        paymentStatus: 'Payment status',
        paymentEnabled: 'Available',
        paymentDisabled: 'Paused',
        noticeTitle: 'Payment notice title',
        noticeMessage: 'Payment notice message',
        paypalEnabled: 'Show PayPal',
        paypalUrl: 'Public PayPal URL',
        paypalCurrency: 'Currency',
        paypalSuggestedAmounts: 'Suggested amounts',
        paypalAllowCustomAmount: 'Allow custom amount',
        expiringSoonDays: 'Days before expiring soon',
        ...
        sortOrder: 'Order',
        url: 'URL',
        requiresAdultWarning: 'Requires +18 warning',
        metadata: 'Metadata JSON',
        label: 'Label',
        ...
        general: 'General',
        adult: '+18',
        paymentSection: 'Support',
        custom: 'Custom',
        saveItem: 'Save link',
        inputError: 'Check the fields, URL, and JSON.',
        loadError: 'Could not load Linktree configuration.',
        saveSuccess: 'Linktree settings saved.',
        itemSaveSuccess: 'Linktree link saved.',
        itemDisableSuccess: 'Link disabled.',
        itemEnableSuccess: 'Link enabled.',
        itemDeleteSuccess: 'Link deleted.',
        filterAll: 'All',
        filtersLabel: 'Linktree filters',
        search: 'Search',
        searchPlaceholder: 'Search by ID, provider, URL, or label',
        results: 'results',
        empty: 'There are no Linktree links registered.',
        loading: 'Loading Linktree configuration...',
        enable: 'Enable',
        disable: 'Disable',
        delete: 'Delete',
        edit: 'Edit',
        amountHelp: 'Suggested amounts are comma-separated. Do not store PayPal secrets or credentials.'
      }
    },
    footer: {
      copyright: '© 2026 クロネコシステム',
  ...
  'zh-CN': {
    ...
    linktree: {
      ...
      introLine3: '限定画廊的访问信息将在恢复可用时另行公布。',
      paymentNoticeTitle: '支付方式暂停',
      paymentNoticeMessage: '目前支付方式暂不可用，恢复时间另行通知。',
      paymentSectionTitle: '支持与钱包',
      paypalSupportTitle: '通过 PayPal 支持',
      paypalSuggestedLabel: '选择建议金额，或输入自定义支持金额。',
      paypalCustomLabel: '自定义金额',
      paypalCustomPlaceholder: '例如：12.50',
      paypalCustomAction: '打开 PayPal',
      paypalCustomError: '请输入 1 到 10000 之间的有效金额。',
      xLabel: 'X',
      xSmall: '最新消息',
      systemButton: '进入画廊系统',
    ...
    admin: {
      tabs: {
        ...
        gallery: '图库管理',
        vipRequests: 'VIP 请求',
        linktree: 'Linktree 管理'
      },
      keyStatus: {
        all: '全部',
        expiringSoon: '即将过期',
        summaryTitle: '访问密钥状态',
        daysRemaining: '距离过期还有 {days} 天。',
        expiresToday: '今天过期。',
        expiredDaysAgo: '已过期 {days} 天。',
        disabledHelp: '此访问密钥已被管理员禁用。',
        noExpiration: '无法读取过期日期。'
      },
      requestFilters: {
        all: '全部',
        pending: '待确认',
      ...
      linktree: {
        kicker: 'Linktree',
        title: 'Linktree 管理',
        subtitle: '管理公开链接、支持链接、钱包和 PayPal 显示状态。',
        settingsTitle: '公开设置',
        settingsDescription: '编辑付款可用状态、PayPal 公开信息和访问密钥即将过期天数。',
        paymentStatus: '付款状态',
        paymentEnabled: '可用',
        paymentDisabled: '暂停',
        noticeTitle: '付款通知标题',
        noticeMessage: '付款通知内容',
        paypalEnabled: '显示 PayPal',
        paypalUrl: 'PayPal 公开 URL',
        paypalCurrency: '货币',
        paypalSuggestedAmounts: '建议金额',
        paypalAllowCustomAmount: '允许自定义金额',
        expiringSoonDays: '即将过期天数',
        saveSettings: '保存设置',
        addItem: '新增链接',
        editItem: '编辑链接',
        cancelEdit: '取消编辑',
        ...
        custom: '自定义',
        saveItem: '保存链接',
        inputError: '请检查字段、URL 和 JSON。',
        loadError: '无法加载 Linktree 配置。',
        saveSuccess: 'Linktree 设置已保存。',
        itemSaveSuccess: 'Linktree 链接已保存。',
        itemDisableSuccess: '链接已禁用。',
        itemEnableSuccess: '链接已启用。',
        itemDeleteSuccess: '链接已删除。',
        filterAll: '全部',
        filtersLabel: 'Linktree 筛选',
        search: '搜索',
        searchPlaceholder: '按 ID、提供方、URL 或标签搜索',
        results: '项结果',
        empty: '没有已注册的 Linktree 链接。',
        loading: '正在加载 Linktree 配置...',
        enable: '启用',
        disable: '禁用',
        delete: '删除',
        edit: '编辑',
        amountHelp: '建议金额用逗号分隔。不要保存 PayPal 密钥或凭据。'
      }
    },
    footer: {
      copyright: '© 2026 クロネコシステム',
  ...
  'zh-TW': {
    ...
    linktree: {
      ...
      introLine3: '限定畫廊的存取資訊將在恢復可用時另行公告。',
      paymentNoticeTitle: '支付方式暫停',
      paymentNoticeMessage: '目前支付方式暫不可用，恢復時間另行通知。',
      paymentSectionTitle: '支持與錢包',
      paypalSupportTitle: '透過 PayPal 支持',
      paypalSuggestedLabel: '選擇建議金額，或輸入自訂支持金額。',
      paypalCustomLabel: '自訂金額',
      paypalCustomPlaceholder: '例如：12.50',
      paypalCustomAction: '開啟 PayPal',
      paypalCustomError: '請輸入 1 到 10000 之間的有效金額。',
      xLabel: 'X',
      xSmall: '最新消息',
      systemButton: '進入畫廊系統',
    ...
    admin: {
      ...
      keyStatus: {
        ...
        expiringSoon: '即將過期',
        summaryTitle: '存取金鑰狀態',
        daysRemaining: '距離過期還有 {days} 天。',
        expiresToday: '今天過期。',
        expiredDaysAgo: '已過期 {days} 天。',
        disabledHelp: '此存取金鑰已被管理員停用。',
        noExpiration: '無法讀取過期日期。'
      },
      requestFilters: {
        all: '全部',
        pending: '待確認',
      ...
      linktree: {
        kicker: 'Linktree',
        title: 'Linktree 管理',
        subtitle: '管理公開連結、支持連結、錢包和 PayPal 顯示狀態。',
        settingsTitle: '公開設定',
        settingsDescription: '編輯付款可用狀態、PayPal 公開資訊和存取金鑰即將過期天數。',
        paymentStatus: '付款狀態',
        paymentEnabled: '可用',
        paymentDisabled: '暫停',
        noticeTitle: '付款通知標題',
        noticeMessage: '付款通知內容',
        paypalEnabled: '顯示 PayPal',
        paypalUrl: 'PayPal 公開 URL',
        paypalCurrency: '貨幣',
        paypalSuggestedAmounts: '建議金額',
        paypalAllowCustomAmount: '允許自訂金額',
        expiringSoonDays: '即將過期天數',
        saveSettings: '儲存設定',
        addItem: '新增連結',
        editItem: '編輯連結',
        cancelEdit: '取消編輯',
        ...
        custom: '自訂',
        saveItem: '儲存連結',
        inputError: '請檢查欄位、URL 和 JSON。',
        loadError: '無法載入 Linktree 設定。',
        saveSuccess: 'Linktree 設定已儲存。',
        itemSaveSuccess: 'Linktree 連結已儲存。',
        itemDisableSuccess: '連結已停用。',
        itemEnableSuccess: '連結已啟用。',
        itemDeleteSuccess: '連結已刪除。',
        filterAll: '全部',
        filtersLabel: 'Linktree 篩選',
        search: '搜尋',
        searchPlaceholder: '依 ID、提供方、URL 或標籤搜尋',
        results: '筆結果',
        empty: '沒有已註冊的 Linktree 連結。',
        loading: '正在載入 Linktree 設定...',
        enable: '啟用',
        disable: '停用',
        delete: '刪除',
        edit: '編輯',
        amountHelp: '建議金額用逗號分隔。不要儲存 PayPal 密鑰或憑證。'
      }
    },
    footer: {
      copyright: '© 2026 クロネコシステム',
